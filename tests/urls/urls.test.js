...
describe('fn: urlGetCurrentByReq', () => {
  test('fn: urlGetCurrentByReq( undefined )', () => {
    expect(Ofn.urlGetCurrentByReq()).toBe('');
  });
...
describe('fn: urlGetHostByReq', () => {
  test('fn: urlGetHostByReq( undefined )', () => {
    expect(Ofn.urlGetHostByReq()).toBe('');
  });
...
describe('fn: urlIsValid', () => {
  test('fn: urlIsValid( undefined )', () => {
    expect(Ofn.urlIsValid()).toBe(false);
  });
...
describe('fn: urlObjByUrl', () => {
  test('fn: urlObjByUrl( undefined )', () => {
    expect(Ofn.urlObjByUrl()).toBe(undefined);
  });
  test('fn: urlObjByUrl( url bad )', () => {
    expect(Ofn.urlObjByUrl('example.com')).toBe(undefined);
  });
...
describe('fn: urlGetParams', () => {
  test('fn: urlGetParams( undefined )', () => {
    expect(Ofn.urlGetParams()).toEqual({});
  });
...
describe('fn: urlEncode', () => {
  test('fn: urlEncode( undefined )', () => {
    expect(Ofn.urlEncode()).toBe('');
  });
  test('fn: urlEncode( url bad )', () => {
    expect(Ofn.urlEncode('example.com?name=chacho tio&suma=1+2')).toBe(
      'example.com%3Fname%3Dchacho%20tio%26suma%3D1%2B2',
    );
  });
  test('fn: urlEncode( url )', () => {
    expect(Ofn.urlEncode('https://example.com?name=chacho tio&suma=1+2')).toBe(
...
describe('fn: urlDecode', () => {
  test('fn: urlDecode( undefined )', () => {
    expect(Ofn.urlDecode()).toBe('');
  });
  test('fn: urlDecode( url bad )', () => {
    expect(Ofn.urlDecode('example.com%3Fname%3Dchacho%20tio%26suma%3D1%2B2')).toBe(
      'example.com?name=chacho tio&suma=1+2',
    );
  });
  test('fn: urlDecode( url )', () => {
    expect(Ofn.urlDecode('https%3A%2F%2Fexample.com%3Fname%3Dchacho%20tio%26suma%3D1%2B2')).toBe(
...
describe('fn: urlStringToPlain', () => {
  test('fn: urlStringToPlain( undefined )', () => {
    expect(Ofn.urlStringToPlain()).toBe('');
  });
  test('fn: urlStringToPlain( url bad )', () => {
    expect(Ofn.urlStringToPlain('example.com?name=chacho tio&suma=1+2')).toBe(
      'example.com?name%3dchacho%20tio&suma%3d1+2',
    );
  });
  test('fn: urlStringToPlain( url )', () => {
    expect(Ofn.urlStringToPlain('https://example.com?name=chacho tio&suma=1+2')).toBe(
...
describe('fn: urlPlainToString', () => {
  test('fn: urlPlainToString( undefined )', () => {
    expect(Ofn.urlPlainToString()).toBe('');
  });
  test('fn: urlPlainToString( url bad )', () => {
    expect(Ofn.urlPlainToString('example.com?name%3dchacho%20tio&suma%3d1+2')).toBe(
      'example.com?name=chacho tio&suma=1+2',
    );
  });
  test('fn: urlPlainToString( url )', () => {
    expect(Ofn.urlPlainToString('https://example.com?name%3dchacho%20tio&suma%3d1+2')).toBe(
      'https://example.com?name=chacho tio&suma=1+2',
    );
  });
});
