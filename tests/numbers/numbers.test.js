...
describe('fn: isEven', () => {
  test('fn: isEven( undefined )', () => {
    expect(Ofn.isEven(undefined)).toBe(false);
  });
  test('fn: isEven( null )', () => {
    expect(Ofn.isEven(null)).toBe(false);
  });
  test('fn: isEven( bool )', () => {
    expect(Ofn.isEven(true)).toBe(false);
  });
  test('fn: isEven( NaN )', () => {
    expect(Ofn.isEven(NaN)).toBe(false);
  });
  test('fn: isEven( infinite )', () => {
    expect(Ofn.isEven(1 / 0)).toBe(false);
  });
...
describe('fn: isOdd', () => {
  test('fn: isOdd( undefined )', () => {
    expect(Ofn.isOdd(undefined)).toBe(false);
  });
  test('fn: isOdd( null )', () => {
    expect(Ofn.isOdd(null)).toBe(false);
  });
  test('fn: isOdd( bool )', () => {
    expect(Ofn.isOdd(true)).toBe(false);
  });
  test('fn: isOdd( NaN )', () => {
    expect(Ofn.isOdd(NaN)).toBe(false);
  });
  test('fn: isOdd( infinite )', () => {
    expect(Ofn.isOdd(1 / 0)).toBe(false);
  });
  test('fn: isOdd( int 0 )', () => {
...
describe('fn: randomMinMax', () => {
  ...
  test('fn: randomMinMax( -10, 10 )', () => {
    let val = Ofn.randomMinMax(-10, 10);
    expect(val).toBeGreaterThanOrEqual(-10);
    expect(val).toBeLessThanOrEqual(10);
  });
});
...
describe('fn: numberFixDecimals', () => {
  test('fn: numberFixDecimals()', () => {
    expect(Ofn.numberFixDecimals()).toBe('');
  });
...
describe('fn: numberPrintDecimals', () => {
  test('fn: numberPrintDecimals()', () => {
    expect(Ofn.numberPrintDecimals()).toBe('');
  });
