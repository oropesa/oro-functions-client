...
describe('fn: isEven', () => {
  ...
  // } );
  test('fn: isEven( NaN )', () => {
    expect(Ofn.isEven(Number.NaN)).toBe(false);
  });
...
describe('fn: isOdd', () => {
  ...
  // } );
  test('fn: isOdd( NaN )', () => {
    expect(Ofn.isOdd(Number.NaN)).toBe(false);
  });
...
describe('fn: isNumeric', () => {
  ...
  test('fn: isNumeric( NaN )', () => {
    expect(Ofn.isNumeric(Number.NaN)).toBe(false);
  });
