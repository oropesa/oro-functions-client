...
describe('fn: cloneArray', () => {
    test( 'fn: cloneArray( undefined )', () => { expect( Ofn.cloneArray() ).toEqual( [] ); } );
    test( 'fn: cloneArray( str )', () => { expect( Ofn.cloneArray( 'chacho' ) ).toEqual( [] ); } );
...
describe('fn: arrayToObjectByKey', () => {
    test( 'fn: arrayToObjectByKey( undefined )', () => { expect( Ofn.arrayToObjectByKey() ).toEqual( {} ); } );
    test( 'fn: arrayToObjectByKey( str )', () => { expect( Ofn.arrayToObjectByKey( 'chacho' ) ).toEqual( {} ); } );
    test( 'fn: arrayToObjectByKey( arr, key )', () => {
        ...
        expect( obj ).toEqual( { chacho: { label: 'chacho', chacho: 'chacho' }, loco: { label: 'loco', loco: 'loco' } } );
    } );
...
describe('fn: arrayValuesByKey', () => {
    test( 'fn: arrayValuesByKey( undefined )', () => { expect( Ofn.arrayValuesByKey() ).toEqual( [] ); } );
    test( 'fn: arrayValuesByKey( str )', () => { expect( Ofn.arrayValuesByKey( 'chacho' ) ).toEqual( [] ); } );
...
describe('fn: arrayCountByKey', () => {
    test( 'fn: arrayCountByKey( undefined )', () => { expect( Ofn.arrayCountByKey() ).toEqual( {} ); } );
    test( 'fn: arrayCountByKey( str )', () => { expect( Ofn.arrayCountByKey( 'chacho' ) ).toEqual( {} ); } );
...
describe('fn: arrayGroupByKey', () => {
    test( 'fn: arrayGroupByKey( undefined )', () => { expect( Ofn.arrayGroupByKey() ).toEqual( {} ); } );
    test( 'fn: arrayGroupByKey( str )', () => { expect( Ofn.arrayGroupByKey( 'chacho' ) ).toEqual( {} ); } );
    test( 'fn: arrayGroupByKey( arr, key )', () => {
        let arr = [ { label: 'chacho', chacho: 'chacho' }, { label: 'loco', loco: 'loco' }, { label: 'chacho', chacho: 'tio' }, ];
        let obj = Ofn.arrayGroupByKey( arr, 'label' );
        expect( obj ).toEqual( { chacho: [ { label: 'chacho', chacho: 'chacho' }, { label: 'chacho', chacho: 'tio' } ], loco: [ { label: 'loco', loco: 'loco' } ] } );
    } );
...
describe('fn: arraySortByKey', () => {
    test( 'fn: arraySortByKey( undefined )', () => { expect( Ofn.arraySortByKey() ).toEqual( [] ); } );
    test( 'fn: arraySortByKey( str )', () => { expect( Ofn.arraySortByKey( 'chacho' ) ).toEqual( [] ); } );
...
describe('fn: arrayGetUnique', () => {
    test( 'fn: arrayGetUnique( undefined )', () => { expect( Ofn.arrayGetUnique() ).toEqual( [] ); } );
    test( 'fn: arrayGetUnique( str )', () => { expect( Ofn.arrayGetUnique( 'chacho' ) ).toEqual( [] ); } );
    ...
    test( 'fn: arrayGetUnique( arr w obj )', () => {
        let arr = [ { chacho: true }, [ 1, 2 ], { chacho: false }, { chacho: true }, [ 1, 2 ], [ 1, 3 ], { chacho: true, tio: false } ];
        let obj = Ofn.arrayGetUnique( arr );
...
describe('fn: arraysIntersection', () => {
    test( 'fn: arraysIntersection( undefined )', () => { expect( Ofn.arraysIntersection() ).toEqual( [] ); } );
    test( 'fn: arraysIntersection( arr )', () => { expect( Ofn.arraysIntersection( [ 1, 2, 3 ] ) ).toEqual( [ 1, 2, 3 ] ); } );
    test( 'fn: arraysIntersection( arr1, arr2 )', () => { expect( Ofn.arraysIntersection( [ 1, 2, 3 ], [ 2, 3, 4 ] ) ).toEqual( [ 2, 3 ] ); } );
    test( 'fn: arraysIntersection( arr1, arr2, arr3, arr4 )', () => { expect( Ofn.arraysIntersection( [ 1, 2, 3 ], [ 2, 3, 4 ], [ 1, 3 ], [ 1, 2, 3 ] ) ).toEqual( [ 3 ] ); } );
});

describe('fn: arraysDifference', () => {
    test( 'fn: arraysDifference( undefined )', () => { expect( Ofn.arraysDifference() ).toEqual( [] ); } );
    test( 'fn: arraysDifference( arr )', () => { expect( Ofn.arraysDifference( [ 1, 2, 3 ] ) ).toEqual( [ 1, 2, 3 ] ); } );
    test( 'fn: arraysDifference( arr1, arr2 )', () => { expect( Ofn.arraysDifference( [ 1, 2, 3 ], [ 2, 3, 4 ] ) ).toEqual( [ 1 ] ); } );
    test( 'fn: arraysDifference( arr1, arr2, arr3, arr4 )', () => { expect( Ofn.arraysDifference( [ 1, 2, 3 ], [ 2, 3, 4 ], [ 2, 3 ], [ 1 ] ) ).toEqual( [] ); } );
    test( 'fn: arraysDifference( arr1, arr2, arr3, arr4 ) 2', () => { expect( Ofn.arraysDifference( [ 1, 2, 3 ], [ 2, 3, 4 ], [ 2, 3 ], [ 4 ] ) ).toEqual( [ 1 ] ); } );
});

describe('fn: arraysDifferenceAll', () => {
    test( 'fn: arraysDifferenceAll( undefined )', () => { expect( Ofn.arraysDifferenceAll() ).toEqual( [] ); } );
    test( 'fn: arraysDifferenceAll( arr )', () => { expect( Ofn.arraysDifferenceAll( [ 1, 2, 3 ] ) ).toEqual( [ 1, 2, 3 ] ); } );
    test( 'fn: arraysDifferenceAll( arr1, arr2 )', () => { expect( Ofn.arraysDifferenceAll( [ 1, 2, 3 ], [ 2, 3, 4 ] ) ).toEqual( [ 1, 4 ] ); } );
    test( 'fn: arraysDifferenceAll( arr1, arr2, arr3, arr4 )', () => { expect( Ofn.arraysDifferenceAll( [ 1, 2, 3 ], [ 2, 3, 4 ], [ 2, 3 ], [ 1 ] ) ).toEqual( [ 4 ] ); } );
});