...
describe('fn: dateObjBySql', () => {
  test('fn: dateObjBySql( undefined )', () => {
    expect(Ofn.dateObjBySql()).toBe(null);
  });
...
describe('fn: dateObjByHtml', () => {
  test('fn: dateObjByHtml( undefined )', () => {
    expect(Ofn.dateObjByHtml()).toBe(null);
  });
...
describe('fn: dateObjByTimestamp', () => {
  test('fn: dateObjByTimestamp( undefined )', () => {
    expect(Ofn.dateObjByTimestamp()).toBe(null);
  });
...
describe('fn: dateIsObj', () => {
  test('fn: dateIsObj( undefined )', () => {
    expect(Ofn.dateIsObj()).toBe(false);
  });
...
describe('fn: dateObjPlusDays', () => {
  test('fn: dateObjPlusDays( undefined )', () => {
    expect(Ofn.dateObjPlusDays()).toBe(null);
  });
...
describe('fn: datesCompare', () => {
  test('fn: datesCompare( undefined )', () => {
    expect(Ofn.datesCompare()).toBe(0);
  });
...
describe('fn: dateIsBetween', () => {
  test('fn: dateIsBetween( undefined )', () => {
    expect(Ofn.dateIsBetween()).toBe(false);
  });
...
describe('fn: datesDiffDays', () => {
  test('fn: datesDiffDays( undefined )', () => {
    expect(Ofn.datesDiffDays()).toBe(0);
  });
  test('fn: datesDiffDays( date )', () => {
    expect(Ofn.datesDiffDays(isoDate)).toBe(0);
  });
  test('fn: datesDiffDays( date1, date2 )', () => {
    expect(Ofn.datesDiffDays(Ofn.dateObjBySql('2021-12-25'), Ofn.dateObjBySql('2022-01-05'))).toBe(
      11,
    );
  });
  test('fn: datesDiffDays( date2, date1 )', () => {
    expect(Ofn.datesDiffDays(Ofn.dateObjBySql('2022-01-05'), Ofn.dateObjBySql('2021-12-25'))).toBe(
      11,
    );
  });
});
...
describe('fn: datesDiffMonths', () => {
  test('fn: datesDiffMonths( undefined )', () => {
    expect(Ofn.datesDiffMonths()).toBe(0);
  });
  ...
  test('fn: datesDiffMonths( date1, date2 )', () => {
    expect(
      Ofn.datesDiffMonths(Ofn.dateObjBySql('2021-12-25'), Ofn.dateObjBySql('2022-01-05')),
    ).toBe(1);
  });
  test('fn: datesDiffMonths( date2, date1 )', () => {
    expect(
      Ofn.datesDiffMonths(Ofn.dateObjBySql('2022-01-05'), Ofn.dateObjBySql('2021-12-25')),
    ).toBe(1);
  });
});
...
describe('fn: datesDiffMonthsArray', () => {
  test('fn: datesDiffMonthsArray( undefined )', () => {
    expect(Ofn.datesDiffMonthsArray()).toEqual([]);
  });
  ...
  test('fn: datesDiffMonthsArray( date1, date2 )', () => {
    expect(
      Ofn.datesDiffMonthsArray(Ofn.dateObjBySql('2021-12-25'), Ofn.dateObjBySql('2022-01-05')),
    ).toEqual([
      { year: '2021', month: '12' },
      { year: '2022', month: '01' },
    ]);
  ...
  test('fn: datesDiffMonthsArray( date2, date1 )', () => {
    expect(
      Ofn.datesDiffMonthsArray(Ofn.dateObjBySql('2022-01-05'), Ofn.dateObjBySql('2021-12-25')),
    ).toEqual([
      { year: '2021', month: '12' },
      { year: '2022', month: '01' },
    ]);
...
describe('fn: dateCheckString', () => {
  test('fn: dateCheckString( undefined )', () => {
    expect(Ofn.dateCheckString()).toBe(false);
  });
