...
const dateObj = {
  ...
  sqldatetimeIso: isoDate.toISOString().replace('T', ' ').slice(0, 19),
...
describe('fn: datesDiffDays', () => {
  ...
  test('fn: datesDiffDays( date1, date2 )', () => {
    expect(
      Ofn.datesDiffDays(Ofn.dateObjBySql('2021-12-25')!, Ofn.dateObjBySql('2022-01-05')!),
    ).toBe(11);
  });
  test('fn: datesDiffDays( date2, date1 )', () => {
    expect(
      Ofn.datesDiffDays(Ofn.dateObjBySql('2022-01-05')!, Ofn.dateObjBySql('2021-12-25')!),
    ).toBe(11);
  });
});
