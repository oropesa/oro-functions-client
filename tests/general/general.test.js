...
describe('fn: type', () => {
  ...
  test('fn: type( NaN )', () => {
    expect(Ofn.type(NaN)).toBe('number');
  });
  ...
  test('fn: type( var class extend strict )', () => {
    ...
    let chacho = new Arr();
    expect(Ofn.type(chacho, true)).toBe('Arr');
  });
});

describe('fn: is(Type)', () => {
  test('fn: isBoolean()', () => {
    expect(Ofn.isBoolean()).toBe(false);
  });
  ...
  test('fn: isString()', () => {
    expect(Ofn.isString()).toBe(false);
  });
  ...
  test('fn: isObject()', () => {
    expect(Ofn.isObject()).toBe(false);
  });
  ...
  test('fn: isRegexp()', () => {
    expect(Ofn.isRegexp()).toBe(false);
  });
  ...
  test('fn: isUndefined()', () => {
    expect(Ofn.isUndefined()).toBe(true);
  });
