...
describe( 'fn: issetGet', () => {
    ...
    test( "fn: issetGet( obj )", () => {
        ...
        interface NumberObject { chacho: number, tio: number }
        interface StringObject { chacho: string, tio: string }
        type ObjectKeys = 'chacho' | 'tio';
        ...
        expect( Ofn.issetGet<string, StringObject, keyof StringObject>( { chacho: 'loco', tio: '' }, 'tio', 'test', false ) ).toBe( 'test' );
    } );
} );
