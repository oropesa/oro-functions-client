...
describe('fn: phpSerialize', () => {
  ...
  //   expect(Ofn.phpSerialize(undefined)).toBe(undefined);
  // });
  test('fn: phpSerialize( str )', () => {
    expect(Ofn.phpSerialize<boolean>(true)).toBe(true);
  });
  test('fn: phpSerialize( str )', () => {
...
describe('fn: phpUnserialize', () => {
  ...
  //   expect(Ofn.phpUnserialize(undefined)).toBe(undefined);
  // });
  ...
  test('fn: phpUnserialize( str json )', () => {
    expect(Ofn.phpUnserialize<{ chacho: boolean }>('{"chacho":true}')).toEqual({ chacho: true });
  });
...
describe('fn: phpIsSerialized', () => {
  ...
  //   expect(Ofn.phpIsSerialized(undefined)).toBe(false);
  // });
