...
describe('fn: getObjectMissedKeys', () => {
  ...
  test('fn: getObjectMissedKeys( obj, arr )', () => {
    ...
    expect(
      Ofn.getObjectMissedKeys<Custom, keyof Custom>({ chacho: true }, ['chacho', 'loco']),
    ).toEqual(['loco']);
  });
...
describe('fn: cloneObjectWithoutKeys', () => {
  ...
  test('fn: cloneObjectWithoutKeys( arr )', () => {
    ...
    type Customs = [Custom1, Custom2];
    let obj1: Customs = [{ chacho: true }, { loco: false }];
    let obj2 = Ofn.cloneObjectWithoutKeys<Customs, number>(obj1, [1]) as unknown as Custom1[];
    expect(Object.keys(obj2)).toEqual(['0']);
...
describe('fn: mergeObjectsDeep', () => {
  ...
  test('fn: mergeObjectsDeep( obj1, obj2 ) deep', () => {
    ...
    let objMerge = Ofn.mergeObjectsDeep<any>(obj1, obj2);
  ...
  test('fn: mergeObjectsDeep( obj1, obj2, obj3, obj4 ) deep', () => {
    ...
    expect(Ofn.mergeObjectsDeep<any>(obj1, obj2, obj3, obj4)).toEqual({
      chacho: true,
      loco: { fleje: false },
      tio: false,
    });
...
describe('fn: objToStringSqlSet', () => {
  ...
  test('fn: objToStringSqlSet( obj )', () => {
    ...
    expect(Ofn.objToStringSqlSet<Custom>({ id: 20, name: "'oro'", today: 'NOW()' })).toBe(
      " id = 20, name = 'oro', today = NOW() ",
    );
  });
});
...
describe('fn: objToStringAttrData', () => {
  ...
  test('fn: objToStringAttrData( obj )', () => {
    ...
    expect(Ofn.objToStringAttrData<Custom>({ id: 20, name: 'oro' })).toBe(
      ' data-id="20" data-name="oro" ',
    );
  });
  test('fn: objToStringAttrData( obj w html )', () => {
    expect(Ofn.objToStringAttrData({ id: 20, name: '<span>oro</span>' })).toBe(
